    ...
    <div className="px-44 pb-8">
      <div className="grid grid-cols-3 gap-8">
        ...
        <Card className="border-blue-700/30 bg-gradient-to-br from-slate-950 via-slate-900/500 to-slate-950">
          ...
          <CardContent className="pt-10 flex flex-col gap-2">
            <div className="px-4 py-6 text-xl font-bold text-zinc-100 bg-slate-800/50 rounded-lg flex items-center gap-2">
        ...
        <Card className="border-blue-700/30 bg-gradient-to-br from-slate-950 via-slate-900/500 to-slate-950">
          ...
          <hr className="my-4 border-blue-700/30" />
          <CardContent className="pt-10 flex flex-col gap-2">
            <div className="px-4 py-4 text-xl font-bold text-zinc-100 bg-slate-800/50 rounded-lg">
              <div className="flex items-center justify-between w-full">
                <h3 className="">Ellias</h3>
                <span className="px-3 py-1 rounded-xl bg-slate-700">9 Total</span>
              </div>
              <div className="flex items-center gap-2 mt-1">
                <IoFlashSharp className="text-yellow-500"/>
                3 ativas
                <GiSportMedal className="text-green-500"/>
                6 concluidos
              </div>
            </div>
            <div className="px-4 py-4 text-xl font-bold text-zinc-100 bg-slate-800/50 rounded-lg">
              <div className="flex items-center justify-between w-full">
                ...
                <span className="px-3 py-1 rounded-xl bg-slate-700">6 Total</span>
              </div>
              <div className="flex items-center gap-2 mt-1">
                <IoFlashSharp className="text-yellow-500"/>
                3 ativas
